      ...
      <div className="flex flex-row flex-wrap">
        ...
        <div className="flex-col xl:w-1/3 lg:w-1/2 md:w-1/2 w-full p-8">
          <Fade bottom>
            ...
            <div className="feature-item-content flex flex-col items-center lg:py-16 sm:py-4 md:py-8">
              ...
              />
              <p className="xl:w-2/3 lg:w-1/2 md:w-3/5 sm:w-4/6 xl:mt-2 lg:mt-1 xl:px-10 px-4 text-center md:pt-1 sm:pt-1 sm:text-sm sm:px-1">
        ...
        <div className="flex-col xl:w-1/3 lg:w-1/2 md:w-1/2 w-full p-8">
          <Fade bottom>
            ...
            <div className="feature-item-content flex flex-col items-center lg:py-16 sm:py-4 md:py-8">
              <img src={Feature_Other} alt="coloseum" className="lg:w-64 lg:h-64 sm:w-56 sm:lg-56" />
              <p className="xxl:w-2/3 lg:w-1/2 md:w-3/5 sm:w-4/6 xl:mt-2 lg:mt-1 xl:px-10 px-4 text-center md:pt-1 sm:pt-1 sm:text-sm sm:px-1">
